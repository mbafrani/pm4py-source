...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.other.clustering',
              'pm4py.algo.other.clustering.versions', 'pm4py.algo.other.decisiontree', 'pm4py.algo.discovery',
              ...
              'pm4py.objects.bpmn.exporter', 'pm4py.objects.bpmn.importer', 'pm4py.objects.petri',
              ...
              'pm4py.objects.conversion.bpmn_to_petri', 'pm4py.objects.conversion.bpmn_to_petri.versions',
              'pm4py.objects.conversion.petri_to_bpmn', 'pm4py.objects.conversion.petri_to_bpmn.util',
              'pm4py.objects.conversion.petri_to_bpmn.versions', 'pm4py.objects.process_tree',
