...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.other.simple', 'pm4py.algo.other.simple.model',
              ...
              'pm4py.algo.other.playout.versions', 'pm4py.algo.other.playout.data_structures',
              'pm4py.algo.other.clustering', 'pm4py.algo.other.clustering.versions', 'pm4py.algo.other.decisiontree',
              ...
              'pm4py.objects.log.importer.xes.versions', 'pm4py.objects.sna', 'pm4py.objects.bpmn',
