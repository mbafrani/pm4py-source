...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.sna', 'pm4py.algo.sna.metrics', 'pm4py.algo.sna.metrics.handover',
              ...
              'pm4py.algo.other.playout.data_structures', 'pm4py.algo.other.clustering',
              ...
              'pm4py.objects.bpmn', 'pm4py.objects.bpmn.exporter', 'pm4py.objects.bpmn.importer', 'pm4py.objects.petri',
              'pm4py.objects.petri.common', 'pm4py.objects.petri.exporter', 'pm4py.objects.petri.importer',
              'pm4py.objects.conversion', 'pm4py.objects.conversion.bpmn_to_petri',
