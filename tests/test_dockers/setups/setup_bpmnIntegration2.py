...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.other.clustering',
              ...
              'pm4py.algo.other.intervaltree', 'pm4py.algo.other.intervaltree.builder',
              'pm4py.algo.other.intervaltree.builder.versions', 'pm4py.algo.other.intervaltree.representation',
              'pm4py.algo.other.intervaltree.representation.versions', 'pm4py.algo.discovery',
              ...
              'pm4py.objects.conversion.bpmn_to_petri.versions', 'pm4py.objects.conversion.lifecycle_log',
              'pm4py.objects.conversion.lifecycle_log.versions', 'pm4py.objects.conversion.petri_to_bpmn',
              ...
              'pm4py.objects.process_tree', 'pm4py.objects.lifecycle_log', 'pm4py.objects.lifecycle_log.util',
